defmodule HotdogLoungeWeb.MetadataChannel do
  use HotdogLoungeWeb, :channel
  require Logger

  def join("metadata", _message, socket) do
    Phoenix.PubSub.subscribe(HotdogLounge.PubSub, "metadata")
    Phoenix.PubSub.subscribe(HotdogLounge.PubSub, "canonical_metadata")
    Phoenix.PubSub.subscribe(HotdogLounge.PubSub, "donation_link")
